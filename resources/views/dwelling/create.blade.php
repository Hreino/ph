                ...
                <form action="{{Route('dwelling.store')}}" method="POST">
                    ...
                    <div class="container">
                            <div class="form-group">
                                ...
                                <input type="number" name="rent" placeholder="$ ----.--" step=".01"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="mortgage" placeholder="$ ----.--" step=".01"
                                class="form-control tourtipguide"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="insurance" placeholder="$ ----.--" step=".01"
                                class="form-control tourtipguide"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="electricity" placeholder="$ ----.--" step=".01"
                                class="form-control tourtipguide"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="propaneGas" placeholder="$ ----.--" step=".01"
                                class="form-control tourtipguide"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="phone" placeholder="$ ----.--" step=".01"
                                class="form-control tourtipguide"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="drinkingWater" placeholder="$ ----.--" step=".01"
                                class="form-control tourtipguide"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="cableTV" placeholder="$ ----.--" step=".01"
                                class="form-control tourtipguide"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="internet" placeholder="$ ----.--" step=".01"
                                class="form-control tourtipguide"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="projects" placeholder="$ ----.--" step=".01"
                                class="form-control tourtipguide"
